...
use super::{
    module::{
        ModuleProcessRecordFnResult, ModulePipelineStepConfigureArgs, ModuleStepConfigureFnResult,
        ModuleStepHandle, StepStartFnResult, Record}, std_types::{self, ConstCharPtr}
    };
...
pub type ModuleStepConfigureFn = extern fn(ModulePipelineStepConfigureArgs) -> ModuleStepConfigureFnResult;
...
pub type StepStartFn = extern fn(ModuleStepHandle) -> StepStartFnResult;
/// Sets a param for module step. Typicaly param is passed from step definition
pub type StepSetParamFn = extern fn(ModuleStepHandle, std_types::ConstCharPtr, std_types::ConstCharPtr);
